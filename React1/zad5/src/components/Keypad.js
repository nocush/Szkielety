function Keypad(props){
    return(
        <div className="button">
            ...
            <button className="secondary" name="*" onClick={e => props.onClick(e.target.name)}>X</button><br/>
            ...
            <button className="secondary" name="-" onClick={e => props.onClick(e.target.name)}>-</button><br/>
