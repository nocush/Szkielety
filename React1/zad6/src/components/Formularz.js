    ...
    return(
        <form onSubmit={handleSubmit} class="col-lg-6 offset-lg-3">
            <div class="form-group mb-3">
                ...
                <input type="text" name="nazwa" class="form-control" value={nazwa} onChange={(e) => ustawNazwe(e.target.value)} />
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <input type="date" name="data" class="form-control" value={data} onChange={(e) => ustawDate(e.target.value)} />
            </div>
